...
public class CommentDeleteJob extends Job<CommentDeleteJob.Parameters, Object> {
    ...
    private static final Logger log = LoggerFactory.getLogger(CommentDeleteJob.class);
    ...
    protected void execute() throws Exception {
        ...
        if (!exists) {
            log.warn("Comment does not exist, skipping");
            return;
        }

        commentIngest.delete(parameters.nodeName, parameters.postingId, parameters.commentId);
    }
